...
export const ContactCard = (props) => {
    ...
    const handleDelete = async () => {
        try {
            const data = await ContactServices.deleteContact('bryam', props.cid);
            console.log(data)
            dispatch({ type: 'getUserAgenda', payload: await data.contacts })} catch (error) {console.log(error);
        }
    }
    ...
    return (
        ...
        <div className="card">
            <div className="card-img col-sm-12 col-md-4 col-lg-6">
                ...
                <div className="datos">
                <h3><i className="fa-solid fa-user"></i> {props.name}</h3>
            ...
            <div className="botones">
                <button className="btn fa fa-pen" onClick={handleEdit}></button>
                <button className="btn fa fa-trash" onClick={handleDelete}></button>
            </div>
        </div>
    )
} 